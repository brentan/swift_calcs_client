...
window.MathquillSetup = function() {
	var FullUnitList = [
		...
		{ name: 'Degrees Celsius: absolute', symbol: 'degC', prefix: false, mksa: [0,0,0,0,0,0,0,0,0]},
		{ name: 'Degrees Fahrenheit: absolute', symbol: 'degF', prefix: false, mksa: [0,0,0,0,0,0,0,0,0]},
		{ name: 'Degrees Celsius: relative', symbol: 'deltaC', prefix: false, mksa: [1,0,0,0,0,1,0,0,0]},
		{ name: 'Degrees Fahrenheit: relative', symbol: 'deltaF', prefix: false, mksa: [1,0,0,0,0,1,0,0,0]},
		...
		{ name: 'United States Dollar', symbol: 'USD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
    { name: 'Euro', symbol: 'EUR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
    { name: 'British Pound Sterling', symbol: 'GBP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
    { name: 'Chinese Yuan', symbol: 'CNY', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
    { name: 'Japanese Yen', symbol: 'JPY', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'United Arab Emirates Dirham', symbol: 'AED', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Afghan Afghani', symbol: 'AFN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Albanian Lek', symbol: 'ALL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Armenian Dram', symbol: 'AMD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Netherlands Antillean Guilder', symbol: 'ANG', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Angolan Kwanza', symbol: 'AOA', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Argentine Peso', symbol: 'ARS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Aruban Florin', symbol: 'AWG', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Azerbaijani Manat', symbol: 'AZN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bosnia-Herzegovina Convertible Mark', symbol: 'BAM', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Barbadian Dollar', symbol: 'BBD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bangladeshi Taka', symbol: 'BDT', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bulgarian Lev', symbol: 'BGN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bahraini Dinar', symbol: 'BHD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Burundian Franc', symbol: 'BIF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bermudan Dollar', symbol: 'BMD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Brunei Dollar', symbol: 'BND', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bolivian Boliviano', symbol: 'BOB', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Brazilian Real', symbol: 'BRL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bahamian Dollar', symbol: 'BSD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bitcoin', symbol: 'BTC', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Bhutanese Ngultrum', symbol: 'BTN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Botswanan Pula', symbol: 'BWP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Belarusian Ruble', symbol: 'BYN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Belize Dollar', symbol: 'BZD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Canadian Dollar', symbol: 'CAD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Congolese Franc', symbol: 'CDF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Swiss Franc', symbol: 'CHF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Chilean Peso', symbol: 'CLP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Colombian Peso', symbol: 'COP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Costa Rican Colón', symbol: 'CRC', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Cuban Convertible Peso', symbol: 'CUC', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Cuban Peso', symbol: 'CUP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Cape Verdean Escudo', symbol: 'CVE', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Czech Republic Koruna', symbol: 'CZK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Djiboutian Franc', symbol: 'DJF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Danish Krone', symbol: 'DKK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Dominican Peso', symbol: 'DOP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Algerian Dinar', symbol: 'DZD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Estonian Kroon', symbol: 'EEK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Egyptian Pound', symbol: 'EGP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Eritrean Nakfa', symbol: 'ERN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Ethiopian Birr', symbol: 'ETB', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Fijian Dollar', symbol: 'FJD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Falkland Islands Pound', symbol: 'FKP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Georgian Lari', symbol: 'GEL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Guernsey Pound', symbol: 'GGP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Ghanaian Cedi', symbol: 'GHS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Gibraltar Pound', symbol: 'GIP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Gambian Dalasi', symbol: 'GMD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Guinean Franc', symbol: 'GNF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Guatemalan Quetzal', symbol: 'GTQ', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Guyanaese Dollar', symbol: 'GYD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Hong Kong Dollar', symbol: 'HKD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Honduran Lempira', symbol: 'HNL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Croatian Kuna', symbol: 'HRK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Haitian Gourde', symbol: 'HTG', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Hungarian Forint', symbol: 'HUF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Indonesian Rupiah', symbol: 'IDR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Israeli New Sheqel', symbol: 'ILS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Manx pound', symbol: 'IMP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Indian Rupee', symbol: 'INR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Iraqi Dinar', symbol: 'IQD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Iranian Rial', symbol: 'IRR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Icelandic Krona', symbol: 'ISK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Jersey Pound', symbol: 'JEP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Jamaican Dollar', symbol: 'JMD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Jordanian Dinar', symbol: 'JOD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Kenyan Shilling', symbol: 'KES', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Kyrgystani Som', symbol: 'KGS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Cambodian Riel', symbol: 'KHR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Comorian Franc', symbol: 'KMF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'North Korean Won', symbol: 'KPW', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'South Korean Won', symbol: 'KRW', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Kuwaiti Dinar', symbol: 'KWD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Cayman Islands Dollar', symbol: 'KYD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Kazakhstani Tenge', symbol: 'KZT', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Laotian Kip', symbol: 'LAK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Lebanese Pound', symbol: 'LBP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Sri Lankan Rupee', symbol: 'LKR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Liberian Dollar', symbol: 'LRD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Lesotho Loti', symbol: 'LSL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Lithuanian Litas', symbol: 'LTL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Latvian Lats', symbol: 'LVL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Libyan Dinar', symbol: 'LYD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Moroccan Dirham', symbol: 'MAD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Moldovan Leu', symbol: 'MDL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Malagasy Ariary', symbol: 'MGA', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Macedonian Denar', symbol: 'MKD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Myanma Kyat', symbol: 'MMK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Mongolian Tugrik', symbol: 'MNT', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Macanese Pataca', symbol: 'MOP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Mauritanian Ouguiya', symbol: 'MRO', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Maltese Lira', symbol: 'MTL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Mauritian Rupee', symbol: 'MUR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Maldivian Rufiyaa', symbol: 'MVR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Malawian Kwacha', symbol: 'MWK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Mexican Peso', symbol: 'MXN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Malaysian Ringgit', symbol: 'MYR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Mozambican Metical', symbol: 'MZN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Namibian Dollar', symbol: 'NAD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Nigerian Naira', symbol: 'NGN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Nicaraguan Cordoba', symbol: 'NIO', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Norwegian Krone', symbol: 'NOK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Nepalese Rupee', symbol: 'NPR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'New Zealand Dollar', symbol: 'NZD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Omani Rial', symbol: 'OMR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Panamanian Balboa', symbol: 'PAB', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Peruvian Nuevo Sol', symbol: 'PEN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Papua New Guinean Kina', symbol: 'PGK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Philippine Peso', symbol: 'PHP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Pakistani Rupee', symbol: 'PKR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Polish Zloty', symbol: 'PLN', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Paraguayan Guarani', symbol: 'PYG', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Qatari Rial', symbol: 'QAR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Romanian Leu', symbol: 'RON', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Serbian Dinar', symbol: 'RSD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Russian Ruble', symbol: 'RUB', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Rwandan Franc', symbol: 'RWF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Saudi Riyal', symbol: 'SAR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Solomon Islands Dollar', symbol: 'SBD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Seychellois Rupee', symbol: 'SCR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Sudanese Pound', symbol: 'SDG', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Swedish Krona', symbol: 'SEK', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Singapore Dollar', symbol: 'SGD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Saint Helena Pound', symbol: 'SHP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Sierra Leonean Leone', symbol: 'SLL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Somali Shilling', symbol: 'SOS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Surinamese Dollar', symbol: 'SRD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Salvadoran Colón', symbol: 'SVC', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Syrian Pound', symbol: 'SYP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Swazi Lilangeni', symbol: 'SZL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Thai Baht', symbol: 'THB', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Tajikistani Somoni', symbol: 'TJS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Turkmenistani Manat', symbol: 'TMT', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Tunisian Dinar', symbol: 'TND', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Tongan Paanga', symbol: 'TOP', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Turkish Lira', symbol: 'TRY', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Trinidad and Tobago Dollar', symbol: 'TTD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'New Taiwan Dollar', symbol: 'TWD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Tanzanian Shilling', symbol: 'TZS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Ukrainian Hryvnia', symbol: 'UAH', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Ugandan Shilling', symbol: 'UGX', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Uruguayan Peso', symbol: 'UYU', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Uzbekistan Som', symbol: 'UZS', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Venezuelan Bolivar Fuerte', symbol: 'VEF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Vietnamese Dong', symbol: 'VND', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Vanuatu Vatu', symbol: 'VUV', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Samoan Tala', symbol: 'WST', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'CFA Franc BEAC', symbol: 'XAF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Silver Ounce', symbol: 'XAG', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Gold Ounce', symbol: 'XAU', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'East Caribbean Dollar', symbol: 'XCD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Special Drawing Rights', symbol: 'XDR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'CFA Franc BCEAO', symbol: 'XOF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Palladium Ounce', symbol: 'XPD', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'CFP Franc', symbol: 'XPF', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Platinum Ounce', symbol: 'XPT', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Yemeni Rial', symbol: 'YER', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'South African Rand', symbol: 'ZAR', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Zambian Kwacha', symbol: 'ZMW', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]},
		{ name: 'Zimbabwean Dollar', symbol: 'ZWL', prefix: false, mksa: [1,0,0,0,0,0,0,1,0]}
	];
	var unitPrefixList = ['µ', 'y', 'z', 'a', 'f', 'p', 'n', 'm', 'c', 'd', 'D', 'h', 'k', 'M', 'G', 'T', 'P', 'E', 'Z', 'Y'];
	window.checkForValidUnit = function(unit_text) {
		var unitslength = FullUnitList.length;
		for(var i = 0; i < unitslength; i++) 
			if(FullUnitList[i].symbol === unit_text) return true;
		var prefix = unit_text[0];
		var test_prefix = false;
		var unitsPlength = unitPrefixList.length;
		for(i = 0; i < unitsPlength; i++) 
			if(unitPrefixList[i] == prefix) { test_prefix = true; break; }
		if(test_prefix) {
			unit_text = unit_text.substr(1);
			for(var i = 0; i < unitslength; i++) 
				if(FullUnitList[i].prefix && (FullUnitList[i].symbol === unit_text)) return true;
		}
		return false;
	}
	...
	var mathquillConfigParams = window.mathquillConfigParams = {
		...
		helpList: { // Helplist used to populate helpful popups for functions.  text in <> will be shown as code, text between || is added to the explanation class.  
			...
			closest:"<<closest([1,2,3,4],3.2)>>\nFind the closest value in the matrix or vector to the desired value.\n|Also See: closest_greater, closest_lesser|",
			closest_greater:"<<closest_greater([1,2,3,4],3.2)>>\nFind the closest value in the matrix or vector to the desired value that is also greater than the desired value.\n|Also See: closest, closest_lesser|",
			closest_lesser:"<<closest_lesser([1,2,3,4],3.2)>>\nFind the closest value in the matrix or vector to the desired value that is also less than the desired value.\n|Also See: closest_greater, closest|",
			...
			absT:"<<absT(23&deg;F)>>\nIf the input temperature is in units of &deg;C or &deg;F, it will be converted to K or Rankine.  Useful to ensure that the absolute temperature is used in calculations when using &degF; or &degC; is ambiguous (Swift Calcs default is to switch these units to &Delta;&deg;F or &Delta;&deg;C to avoid the ambiguity).\n|Also See: mksa, relT|",
			relT:"<<relT(23&deg;F)>>\nIf the input temperature is in units of &deg;C or &deg;F, it will be converted to &Delta;&deg;C or &Delta;&deg;F.  Useful to ensure that the relative temperature is used in calculations when using &degF; or &degC; is ambiguous.\n|Also See: mksa, absT|",
