...
window.MathquillSetup = function() {
	...
	MathQuill.config({
		...
		helpList: { // Helplist used to populate helpful popups for functions.  text in <> will be shown as code, text between || is added to the explanation class.  
			...
			kevlin:"<<kelvin(23&deg;F)>>\nReturns the input temperature as Kelvin if it is in units of &deg;C, &deg;F, Kelvin, or Rankine.  Useful to ensure that the absolute temperature is used in calculations when using &degF; or &degC; is ambiguous.\n|Also See: mksa|",
