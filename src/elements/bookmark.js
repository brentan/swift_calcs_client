...
var bookmark = P(EditableBlock, function(_, super_) {
	_.klass = ['bookmark'];
	_.helpText = "<<Bookmark>>\nCreate a bookmark at this location in the worksheet.  Find your bookmarks quickly with the <i>bookmarks</i> link in the view menu, and search for bookmarks when opening documents in the file browser.";
