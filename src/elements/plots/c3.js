...
(function (window) {
    ...
    c3_chart_internal_fn.isWithinBar = function (that) {
        var mouse = this.d3.mouse(that), box = that.getBoundingClientRect(),
            seg0 = that.getPathData()[0], seg1 = that.getPathData()[1],
            x = Math.min(seg0.values[seg0.type === "C" ? 4 : 0], seg1.values[seg0.type === "C" ? 4 : 0]), y = Math.min(seg0.values[seg0.type === "C" ? 5 : 1], seg1.values[seg0.type === "C" ? 5 : 1]),
    ...
    var isValue = c3_chart_internal_fn.isValue = function (v) {
        ...
        getPathBox = c3_chart_internal_fn.getPathBox = function (path) {
            var box = path.getBoundingClientRect(),
                items = [path.getPathData()[0], path.getPathData()[1]],
                minX = items[0].values[items[0].type === "C" ? 4 : 0], minY = Math.min(items[0].values[items[0].type === "C" ? 5 : 1], items[1].values[items[1].type === "C" ? 5 : 1]);
